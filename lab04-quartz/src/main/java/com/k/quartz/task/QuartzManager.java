...
public class QuartzManager {
    ...
    public void addJob(String jobName, String groupName, String triggerName, String cronExpression, Class<?> clazz)
    ...
    public void modifyJob(String groupName, String triggerName, String cronExpression) throws SchedulerException {
        ...
        if (!oldCronExpression.equalsIgnoreCase(cronExpression)) {
            CronTrigger newTrigger = TriggerBuilder.newTrigger().withIdentity(triggerName, groupName)
                    .withSchedule(CronScheduleBuilder.cronSchedule(cronExpression)).build();
